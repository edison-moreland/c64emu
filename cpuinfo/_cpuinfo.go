// Code generated on 2022-04-01T16:42:08-07:00; DO NOT EDIT.
// MOS 6502 (1975)
...
const (
	Vector_RESET Vector = uint16(0xfffc)
	Vector_IRQ   Vector = uint16(0xfffe)
	Vector_NMI   Vector = uint16(0xfffa)
)

type StatusFlag int

const (
	Status_N StatusFlag = 1 << 7 // Negative
	Status_V StatusFlag = 1 << 6 // Overflow
	Status_B StatusFlag = 1 << 4 // Break Command
	Status_D StatusFlag = 1 << 3 // Decimal
	Status_I StatusFlag = 1 << 2 // Interrupt Disable
	Status_Z StatusFlag = 1 << 1 // Zero
	Status_C StatusFlag = 1 << 0 // Carry
)
...
func Decode(opcode byte) (Instruction, error) {
	...
	case uint8(0x1):
		return Instruction{
			...
			AffectedFlags:  Status_N | Status_Z,
	...
	case uint8(0x6):
		return Instruction{
			AddressingMode: AddressingMode_ZeroPage,
			AffectedFlags:  Status_N | Status_Z | Status_C,
	...
	case uint8(0x24):
		return Instruction{
			AddressingMode: AddressingMode_ZeroPage,
			AffectedFlags:  Status_N | Status_V | Status_Z,
			Category:       MnemonicCategory_Logic,
	...
	case uint8(0x28):
		return Instruction{
			AddressingMode: AddressingMode_Implied,
			AffectedFlags:  Status_N | Status_V | Status_D | Status_I | Status_Z | Status_C,
			Category:       MnemonicCategory_Stack,
	...
	case uint8(0x61):
		return Instruction{
			AddressingMode: AddressingMode_XIndexedZeroPageIndirect,
			AffectedFlags:  Status_N | Status_V | Status_Z | Status_C,
